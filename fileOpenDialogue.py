...
def upload_file():
    ...
    # file_view = tkinter.Button(create_box,image=view) # using Button
    # file_view.grid(row=6,column=1)
...
buttonRock = tkinter.Button(mentor_list_box, image=theRock, width=200, height=200)
...
buttonZuck = tkinter.Button(mentor_list_box, image=zuckerberg, width=200, height=200)
...
buttonNat = tkinter.Button(mentor_list_box, image=portman, width=200, height=200)
...
buttonwalhberg = tkinter.Button(mentor_list_box, image=mwahlberg, width=200, height=200)
...
buttonbill = tkinter.Button(mentor_list_box, image=gates, width=200, height=200)
...
mentor_q1_label = Label(create_box, text='\nProvide a brief description. Degree and Interests', justify=CENTER, font=('Bodoni MT', 12),
                        bg='white', fg='black')
