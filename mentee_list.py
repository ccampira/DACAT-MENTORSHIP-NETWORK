...
class NewWindow2(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        zuck_label3 = Label(zuck_frame, text=f'Hi My names Mark, a current professional in the industry of software development\n'
                                             f'I am eager to mentor and teach incoming ASU professionals or Alumni\n'
                                             f'I have over 10 years of experience in development and would love to share\n'
                                             f'what I have learned over the past 10 years with you!', font=('Bodoni MT', 16),
                           bg='white')
...
class NewWindow3(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        nat_label3 = Label(nat_frame, text=f'Hi My names Natalie, a current professional in the industry of software development\n'
                                             f'I am eager to mentor and teach incoming ASU professionals or Alumni\n'
                                             f'I have over 10 years of experience in development and would love to share\n'
                                             f'what I have learned over the past 10 years with you!', font=('Bodoni MT', 16),
                           bg='white')
...
class NewWindow4(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        bill_label3 = Label(bill_frame, text=f'Hi My names Bill, a current professional in the industry of software development\n'
                                             f'I am eager to mentor and teach incoming ASU professionals or Alumni\n'
                                             f'I have over 10 years of experience in development and would love to share\n'
                                             f'what I have learned over the past 10 years with you!', font=('Bodoni MT', 16),
                           bg='white')
...
class NewWindow5(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        avatar_label3 = Label(avatar_frame, text=f'Hi My names Jake, a current professional in the industry of software development\n'
                                             f'I am eager to mentor and teach incoming ASU professionals or Alumni\n'
                                             f'I have over 10 years of experience in development and would love to share\n'
                                             f'what I have learned over the past 10 years with you!', font=('Bodoni MT', 16),
                           bg='white')
...
mentee_username_entry = Entry(box1, textvariable=mentee_username, justify=LEFT, width=20, font=('Bodoni MT', 11),
                              bg='#fbfbfb')
mentee_username_entry.grid(row=3, column=1, pady=20, padx=10, sticky=W)
mentee_password_entry = Entry(box1, textvariable=mentee_password, justify=LEFT, width=20, font=('Bodoni MT', 11),
                              show="*", bg='#fbfbfb')
...
welcome_label = Label(mentor_list_box, text=f'Welcome to DACAT Mentorship Network', font=('Bodoni MT', 35),
                      bg='white')
